...
\chapter{Rocket Tests}\label{cha:experimental}
	...
	Apart from changing larger parts of the experimental setup, reloading proceduce requires swapping the rocket's interior. In figure \ref{fig:kmno4foam2}, the decomposition chamber is visible with its inner MDF--shell casing, filled with \chem{KMnO_4}--permeated foam. The inner casing prevents liquid puddles from building up and causing trouble, in the form of instant vapourization into large quantities of gas.
