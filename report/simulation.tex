...
\begin{figure}
	...
	\caption{Scheme showing the implementation of the rocket's ignition algorithm. A more detailed description of the flowchart can be found in appendix \ref{App:C}.}
	\label{fig:flowchart}
\end{figure}
