...
\subsection{Isentropic Flow}
	...
	\begin{enumerate}
		...
		\item{The fluid velocity inside the chamber is approximately zero, allowing us to assume stagnated pressure.}
	\end{enumerate}