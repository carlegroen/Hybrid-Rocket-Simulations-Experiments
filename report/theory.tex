...
\subsection{Combustion Chamber}
	...
	\subsubsection{Autoignition}
		...
		Autoignition time $t_\text{auto}$ is given by:
		\begin{align*}
		...
		Back--of--the--envelope calculations shows that the autoignition time is on the order of magnitude $10^{-5}$, which is way faster than anything we should be able to measure. It is thus assumed to be far too small to have any real influence, compared to the autoignition temperature.
