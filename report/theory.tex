...
\section{Isentropic Flow}
	...
	\begin{align}
		...
		\intertext{This yields several key relationships between stagnation properties for pressure, density and temperature according to \cite[chapter 3, p.~60-63]{turbomac}:}
